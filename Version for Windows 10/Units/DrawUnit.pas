...
begin
  ...
  Label1.Left := NewWidth - Label1.Width - 8 - 5;  // right
  Label1.Top := NewHeight - Label1.Height - 26 - 10;  // bottom
  Label2.Left := NewWidth - Label2.Width - 13 - 8;  // right
  ...
  SettingsBtn.Left := NewWidth - 50 - 10;
  ReselectMapBtn.Left := NewWidth - 170 - 10;
