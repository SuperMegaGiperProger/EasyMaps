...
type
  ...
  TBinHeap = record
    arr: array of Pointer;  // array of elements, arr[0] - root of tree
    size: integer;  // num of elements,
    memSize: integer;  // allocated memory(in num of elements)
    dMemory: integer;  // memory increment
    compare: TCompare;  // function to compare
  end;
  TBinHeapPt = ^TBinHeap;
...
procedure clear(var heap: TBinHeap; disposeMem: boolean = false); overload;
procedure siftUp(var heap: TBinHeap; i: integer);  // element [i] goes up, while
                                                   // heap unordered
procedure siftDown(var heap: TBinHeap; i: integer = 0);  // elem. [i] goes down,
                                                         // while heap unordered
...
procedure clear(var heap: TBinHeap; disposeMem: boolean = false);
var
  i: integer;
begin
  with heap do
